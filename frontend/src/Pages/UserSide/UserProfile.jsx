...
function UserProfile() {
    ...
    return (
        <div className='font-googleFont'>
            <Header />
            <div className='w-full min-h-[650px] bg-white flex'>
                <div className='w-96 h-[600px] ml-10'>
                    <div className='w-72 h-80 border border-gray-500 rounded-xl  flex flex-col  items-center'>
                        ...
                        {user.account_status === 'verified' ? (
                            <p><span class="inline-flex items-center justify-center w-6 h-6 me-2 text-sm font-semibold text-blue-800 bg-blue-100 rounded-full dark:bg-gray-700 dark:text-blue-400">
                    ...
                    <div className='w-72 h-48 mt-2 rounded-xl  flex flex-col  items-center'>
                        <div className=' rounded-lg w-full h-10 flex justify-center items-center mt-2 border border-gray-500'>
                            <h1>ORDERS</h1>
                        </div>
                        <div className=' rounded-lg w-full h-10 flex justify-center items-center mt-2 border border-gray-500'>
